...
// O aluno se inscreve na instituição, dando o nome e CPF, e recebe o matricula e senha
...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Menu principal 
			...
			// Como doscente:
				// Editar informações pessoais (Nome)
				// Editar informações de disciplinas (Nome das disciplinas, Escolher disciplinas para lecionar, Colocar notas dos estudantes)
		...
		// 1- CRUD - Estudante, Professor, Disciplina, Turma, Semestre/Periodo
			...
			// Professor - Nome, CPF, Matéria
			// Disciplina - Nome da disciplinas, Professor   
			// Turma - Ano, Código, Disciplina
		// 2- Código único para as turmas
